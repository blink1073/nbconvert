...
- Pin mistune for now by @blink1073 in [#1808](https://github.com/jupyter/nbconvert/pull/1808)
...
- Switch to flit build backend by @blink1073 in
  [#1767](https://github.com/jupyter/nbconvert/pull/1767)
